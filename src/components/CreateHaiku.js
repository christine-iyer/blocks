  ...
  return (
    <>
        ...
        <div className='container'>
          <Form style={{ width: '40%', position: 'sticky', float: 'right' }}
            className='form'
            onSubmit={(e) => {
              e.preventDefault()
              createHaiku()
          ...
          >
            <div >
              ...
              <Form.Control style={{ backgroundColor: haiku.color }} type="color" id="exampleColorInput" value={haiku.color} name="color" defaultValue="#ff0000" title="Choose your color" onChange={handleChange} />
            </div>
